...
Future capabilities will build upon the existing architecture rather than redefine it.
...
Each document within this collection explores one major capability of the platform.
